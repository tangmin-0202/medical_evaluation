...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the real CP02/CP09/CP10/CP11 report pipeline",
    )
    ...
    parser.add_argument(
        "--only", choices=("cp_02", "cp_09", "cp_10", "cp_11"), default=None,
    )
    return parser
...
def main() -> int:
    ...
    selected = {
        ...
        if item.checkpoint_id in {"cp_02", "cp_09", "cp_10", "cp_11"}
    }
