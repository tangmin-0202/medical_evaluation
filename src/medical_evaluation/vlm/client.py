...
def template_fallback(reason_code: str) -> VlmReview:
    templates = {
        ...
        "wrong_punch_hole_selected": (
            "CP02最后可靠可见状态中，对准的不是孔径第二大的孔。",
            "转动孔盘，使冲针对准按孔径从大到小第二大的孔后再打孔。",
        ),
        "unreliable_hole_selection": (
            "孔径排序或最后稳定对孔关系不够清晰。",
            "请保留CP02结束前孔盘和所选孔清晰可见的画面。",
        ),
        "unreliable_residue_evidence": (
            "无法可靠确认选中孔内是否存在绿色残留。",
            "请在CP02结束前保留目标孔内部清晰可见的画面。",
        ),
        "residue_not_cleaned": (
            "CP02最后可靠可见状态中，目标孔内仍有绿色残留。",
            "CP02结束前确认第二大孔内没有绿色残留。",
        ),
        "unreliable_cleanup_result": (
            "清理接触或清理后的孔内结果不够清晰。",
            "清理同一孔后停留片刻，确认绿色残留是否消失。",
        ),
        "residue_remaining": (
            "清理后选中孔内仍有绿色残留。",
            "继续清理同一孔，直至绿色残留消失。",
